...
insert into user (user_id, username, password, first_name, last_name, role) values
    ...
    (4, 'JJohnson', '$2a$10$04qYVTsskUNhDATOFF3Hk.jVmQVaHG/MxzNMU2AMaSWx/t344pIhS'/*test_password*/, 'James', 'Johnson', 'CUSTOMER'),
    (5, 'MaryW', '$2a$10$04qYVTsskUNhDATOFF3Hk.jVmQVaHG/MxzNMU2AMaSWx/t344pIhS'/*test_password*/, 'Mary', 'Williams', 'CUSTOMER'),
    (6, 'LinMil', '$2a$10$04qYVTsskUNhDATOFF3Hk.jVmQVaHG/MxzNMU2AMaSWx/t344pIhS'/*test_password*/, 'Linda', 'Miller', 'CUSTOMER'),
    (7, 'RichyRich', '$2a$10$04qYVTsskUNhDATOFF3Hk.jVmQVaHG/MxzNMU2AMaSWx/t344pIhS'/*test_password*/, 'Richard', 'Harris', 'CUSTOMER')
;
...
insert into availability values
    (0, 'FRIDAY', {t '08:00:00'}, {t '16:00:00'})
;

insert into service_worker_availability values
    (0, 0, 0, {d '2020-09-24'}, {d '2020-10-02'})
;
...
insert into booking values
    ...
    (1, 0, 1, {ts '2020-10-02 15:30:00.00'}, {ts '2020-08-18 18:47:52.69'}, {ts '2020-08-20 00:00:00.00'}, 'CANCELLED')
;